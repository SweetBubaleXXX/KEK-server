...
class TestCrud(TestWithKeyRecord):
    ...
    def test_create_root_folder(self):
        ...
        folder_record = (
            ...
            .filter_by(owner_id=self.key_record.id, full_path=models.ROOT_PATH)
            .first()
        )
    ...
    def test_create_child_folder(self):
        ...
        child_folder = crud.create_child_folder(
    ...
    def test_move_folder(self):
        ...
        updated_folder_record = crud.move_folder(
